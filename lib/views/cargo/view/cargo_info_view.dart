                  ...
                  Column(
                    children: [
                      ListTile(
                        ...
                        minLeadingWidth: 140,
                        leading: Text('İl :', style: Get.theme.textTheme.headline4?.copyWith(color: Colors.black)),
                        title: Text(
                          addressModel!.city,
                          style: Get.theme.textTheme.headline5?.copyWith(
                              color: Color.fromARGB(255, 136, 52, 6), fontFamily: ConstTextStyle.fontFamilyMontserrat),
                        ),
                      ),
                      ListTile(
                        contentPadding: EdgeInsets.all(8),
